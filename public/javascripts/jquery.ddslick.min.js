(function (a) {
	function g(a, b) {
		...
		if (l.showSelectedHTML) {
			d.html((m.imageSrc ? '<span class="dd-selected-image'  + " " + m.imageSrc + '" ></span>' : "") + (m.text ? '<label class="dd-selected-text">' + m.text + "</label>" : "") + (m.description ? '<small class="dd-selected-description dd-desc' + (l.truncateDescription ? " dd-selected-description-truncated" : "") + '" >' + m.description + "</small>" : ""))
		} else
			d.html(m.text);
		e.val(m.value);
		...
		return this.each( function () {
			...
			if (!f) {
				...
				a.each(b.data, function (a, c) {
					...
					m.append("<li>" + '<a class="dd-option">' + (c.value ? ' <input class="dd-option-value" type="hidden" value="' + c.value + '" />' : "") + (c.imageSrc ? ' <span class="dd-option-image' + " " + c.imageSrc + '" ></span>' : "") + (c.text ? ' <label class="dd-option-text">' + c.text + "</label>" : "") + (c.description ? ' <small class="dd-option-description dd-desc">' + c.description + "</small>" : "") + "</a>" + "</li>")
				});
				var n = {
					settings: b,
					original: k,
